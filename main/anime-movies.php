    ...
    <section class="categories-grid-section spad">
        <div class="container" id="anime-movies">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title">
                        <a href="anime-movies.php">Anime Movies (<?= $dbData->get_anime_movies_num(); ?>)</a>
                    </div>
                ...
                <div class="col-lg-12 p-0">
                    <div class="row">
                        ...
                        $limit = 12;
                        $total_rows = $dbData->get_anime_movies_num();
                        ...
                        if (isset($_GET['order'])) {
                            if ($_GET['order'] == "alphaAsc") {
                                $rows = $dbData->get_anime_movies("title", "ASC", $initial_page, $limit);
                            } else if ($_GET['order'] == "alphaDesc") {
                                $rows = $dbData->get_anime_movies("title", "DESC", $initial_page, $limit);
                            } else if ($_GET['order'] == "idAsc") {
                                $rows = $dbData->get_anime_movies("id", "ASC", $initial_page, $limit);
                            } else if ($_GET['order'] == "ratingAsc") {
                                $rows = $dbData->get_anime_movies("rating", "DESC", $initial_page, $limit);
                            }
                        } else {
                            $rows = $dbData->get_anime_movies("released_dt", "DESC", $initial_page, $limit);
                        }
                        foreach ($rows as $row) :
                    ...
                    <div class="pagination-item text-center">
                        ...
                        if ($page_number >= 2) {
                            $href = "anime-movies.php?page=$start";
                        ?>
                            <a href="anime-movies.php?page=1">
                        ...
                        ?>
                            ...
                            <a href="anime-movies.php?page=<?= $total_pages ?>">
