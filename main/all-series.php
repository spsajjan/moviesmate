    ...
    <section class="categories-grid-section spad">
        <div class="container" id="anime-movies">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title">
                        <a href="all-series.php"> All Series (<?= get_series_num(); ?>)</a>
                    </div>
                ...
                <div class="col-lg-12 p-0">
                    <div class="row">
                        ...
                        if (isset($_GET['order'])) {
                            if ($_GET['order'] == "alphaAsc") {
                                $rows = get_series("title", "ASC", $initial_page, $limit);
                            } else if ($_GET['order'] == "alphaDesc") {
                                $rows = get_series("title", "DESC", $initial_page, $limit);
                            } else if ($_GET['order'] == "idAsc") {
                                $rows = get_series("id", "ASC", $initial_page, $limit);
                            } else if ($_GET['order'] == "ratingAsc") {
                                $rows = get_series("id", "DESC", $initial_page, $limit);
                            }
                        } else {
                            $rows = get_series("released_dt", "DESC", $initial_page, $limit);
                        }
                        foreach ($rows as $row) :
                    ...
                    <div class="pagination-item">
                        ...
                        for ($page_number = 1; $page_number <= $total_pages; $page_number++) :
                            $href = "all-series.php?page=" . $page_number;
